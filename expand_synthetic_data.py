...
def generate_synthetic_data(num_rows=5000):
    ...
    # Expanded possible values for each categorical feature
    genders = ['M', 'F']
    procedure_codes = ['27447', '29881', '99213', '12001', '36415']
    diagnosis_codes = ['M17.11', 'K21.9', 'I10', 'E11.9', 'N18.9']
    specialties = [
        'Ortho Surgeon', 'Cardiologist', 'Primary Care', 'Dermatologist', 'ENT',
        'Neurosurgeon', 'Pulmonologist', 'Gastroenterologist'
    ]
    payers = [
        'Medicare', 'Aetna', 'Cigna', 'UnitedHealthcare',
